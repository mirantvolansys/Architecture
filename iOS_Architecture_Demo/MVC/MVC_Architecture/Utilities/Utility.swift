...
struct DeviceType {
    ...
    static let IS_IPHONE_4_OR_LESS  = IS_IPHONE && UIScreen.main.nativeBounds.size.height < 1136.0
    static let IS_IPHONE_5          = IS_IPHONE && UIScreen.main.nativeBounds.size.height == 1136.0
    static let IS_IPHONE_5C         = IS_IPHONE_5
    static let IS_IPHONE_5S         = IS_IPHONE_5
    static let IS_IPHONE_6          = IS_IPHONE && UIScreen.main.nativeBounds.size.height == 1334.0
    static let IS_IPHONE_6S         = IS_IPHONE_6
    static let IS_IPHONE_6P         = IS_IPHONE && UIScreen.main.nativeBounds.size.height == 2208.0
    static let IS_IPHONE_6S_PLUS    = IS_IPHONE_6P
    static let IS_IPHONE_7          = IS_IPHONE_6
    static let IS_IPHONE_7P         = IS_IPHONE_6P
    static let IS_IPHONE_8          = IS_IPHONE_6
    static let IS_IPHONE_8P         = IS_IPHONE_6P
    static let IS_IPHONE_X          = IS_IPHONE && UIScreen.main.nativeBounds.height == 2436.0
    static let IS_IPHONE_XR         = IS_IPHONE && UIScreen.main.nativeBounds.height == 1792.0
    static let IS_IPHONE_XS         = IS_IPHONE_X
    static let IS_IPHONE_XS_MAX     = IS_IPHONE && UIScreen.main.nativeBounds.height == 2688.0
